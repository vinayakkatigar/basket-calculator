...
class BasketCalculatorApplicationTests {
	...
	void testNotAppleNotOrangesItems() {
        List<String> basketItems = of("grapes");
        RuntimeException  thrown = assertThrows(
                RuntimeException.class,
